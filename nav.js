...
(function () {
  ...
  style.textContent = [
    ...
    '.pnf-footer-col h4{font-size:12px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.4);margin-bottom:12px;}',
    ...
    '.pnf-footer-trust li{font-size:12px;color:rgba(255,255,255,0.55);display:flex;align-items:center;gap:8px;line-height:1.5;}',
    ...
    '.pnf-footer-popular h4{font-size:12px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:rgba(255,255,255,0.4);margin-bottom:12px;}',
    ...
    '.pnf-cf label{font-size:12px;font-weight:700;letter-spacing:0.07em;text-transform:uppercase;color:#5A6E78;margin-bottom:5px;display:block;}',
    '.pnf-cf input,.pnf-cf select,.pnf-cf textarea{width:100%;padding:11px 14px;border:1.5px solid #D8E4E8;border-radius:7px;font-family:var(--pnf-font);font-size:14px;color:#1A2832;background:#F2FAFE;outline:none;transition:border-color 0.2s;}',
    ...
    '.pnf-cf-fine{font-size:12px;color:#5A6E78;text-align:center;margin-top:6px;}',
    ...
    '.gc-sub{font-size:.76rem;color:var(--muted,#607080);margin-bottom:8px;display:flex;align-items:center;gap:4px;}',
    '.gc-desc{font-size:.78rem;color:var(--muted,#607080);line-height:1.55;margin-bottom:10px;}',
    '.gc-cta{font-size:.78rem;font-weight:700;color:var(--blue,#00B0F8);}',
    ...
    '.pnf-bz-more{margin-top:auto;background:rgba(0,176,248,.08);border:1px solid rgba(0,176,248,.25);color:var(--blue,#00B0F8);font-family:\'Figtree\',sans-serif;font-size:.78rem;font-weight:700;padding:6px 12px;border-radius:5px;cursor:pointer;align-self:flex-start;transition:background .15s;}',
    ...
    '.pnf-bz-modal .pnf-bz-modal-eyebrow{font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.55);margin-bottom:7px;}',
    ...
    '.pnf-more-cta-btn{background:#6CB71E;color:#145079;font-size:.8rem;font-weight:800;padding:10px 22px;border-radius:7px;text-decoration:none;white-space:nowrap;transition:background .2s;flex-shrink:0;}',
