...
(function () {
  ...
  style.textContent = [
    ':root{--pnf-navy:#145079;--pnf-accent:#00B0F8;--pnf-dune:#62C000;--pnf-white:#FFFFFF;--pnf-muted:rgba(255,255,255,0.45);--pnf-font:\'Figtree\',sans-serif;--pnf-display:\'Playfair Display\',serif;}',
    ...
    '.pnf-link{font-family:var(--pnf-font);font-size:15px;font-weight:600;color:rgba(255,255,255,0.78);text-decoration:none;padding:9px 14px;white-space:nowrap;transition:color 0.15s,background 0.15s;border-bottom:2px solid transparent;border-radius:6px 6px 0 0;}',
    '.pnf-link:hover{color:var(--pnf-white);background:rgba(255,255,255,0.06);}',
    '.pnf-link.active{color:var(--pnf-white);border-bottom-color:var(--pnf-accent);background:rgba(0,176,248,0.08);}',
    // CTA button
    '.pnf-cta{font-family:var(--pnf-font);font-size:15px;font-weight:700;background:var(--pnf-accent);color:var(--pnf-white);padding:8px 18px;border-radius:100px;text-decoration:none;white-space:nowrap;flex-shrink:0;transition:background 0.2s;}',
    '.pnf-cta:hover{background:#0096DC;}',
    // Facebook icon
    '.pnf-fb{display:flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:6px;background:rgba(255,255,255,0.08);color:var(--pnf-muted);text-decoration:none;font-size:15px;font-weight:700;flex-shrink:0;transition:background 0.15s,color 0.15s;}',
    ...
    '@media (max-width:520px){.pnf-bcstrip{padding:9px 16px;font-size:15px;}}',
    // Breadcrumb (category/listing nav - retained, not deployed)
    '.pnf-breadcrumb{display:flex;align-items:center;gap:0;flex:1;overflow:hidden;font-size:15px;color:rgba(255,255,255,0.45);white-space:nowrap;min-width:0;}',
    ...
    '.pnf-back{font-family:var(--pnf-font);font-size:15px;font-weight:500;color:rgba(255,255,255,0.55);text-decoration:none;display:flex;align-items:center;gap:6px;transition:color 0.15s;position:absolute;left:50%;transform:translateX(-50%);}',
    ...
    '.pnf-drawer-cta{display:block;text-align:center;background:var(--pnf-accent);color:var(--pnf-white);font-family:var(--pnf-font);font-size:15px;font-weight:700;padding:11px;border-radius:8px;text-decoration:none;}',
    '.pnf-drawer-fb{display:flex;align-items:center;justify-content:center;gap:8px;font-family:var(--pnf-font);font-size:15px;font-weight:600;color:rgba(255,255,255,0.45);text-decoration:none;}',
    '.pnf-drawer-fb:hover{color:var(--pnf-white);}',
    '.pnf-drawer-fb svg{width:14px;height:14px;}',
    '.pnf-drawer-link-sm{font-size:15px;color:rgba(255,255,255,0.4);text-decoration:none;text-align:center;padding:4px 0;font-family:var(--pnf-font);}',
    ...
    '.pnf-footer-tagline{font-size:15px;color:rgba(255,255,255,0.38);line-height:1.7;margin-bottom:18px;max-width:280px;}',
    '.pnf-footer-social{display:flex;gap:8px;margin-bottom:16px;}',
    '.pnf-social-btn{display:flex;align-items:center;gap:7px;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.1);border-radius:7px;padding:7px 12px;font-size:15px;font-weight:600;color:rgba(255,255,255,0.6);text-decoration:none;transition:all 0.15s;}',
    ...
    '.pnf-social-btn .fb-icon{font-size:15px;font-weight:800;}',
    '.pnf-social-btn svg{width:14px;height:14px;}',
    '.pnf-contact-link{display:inline-flex;align-items:center;gap:6px;font-size:15px;font-weight:600;color:var(--pnf-accent);cursor:pointer;background:none;border:none;padding:0;margin:0;font-family:var(--pnf-font);line-height:1.5;appearance:none;}',
    '.pnf-contact-link:hover{color:var(--pnf-white);}',
    '.pnf-footer-col h4{font-size:15px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.4);margin-bottom:12px;}',
    '.pnf-footer-col h4+h4{margin-top:20px;}',
    '.pnf-footer-links{list-style:none;display:flex;flex-direction:column;gap:7px;}',
    '.pnf-footer-links a{font-size:15px;color:rgba(255,255,255,0.5);text-decoration:none;transition:color 0.15s;}',
    '.pnf-footer-links a:hover{color:var(--pnf-white);}',
    '.pnf-footer-links button{font-size:15px;color:rgba(255,255,255,0.5);background:none;border:none;padding:0;cursor:pointer;font-family:var(--pnf-font);transition:color 0.15s;text-align:left;}',
    '.pnf-footer-links button:hover{color:var(--pnf-white);}',
    '.pnf-footer-bottom{border-top:1px solid rgba(255,255,255,0.08);padding-top:20px;display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;font-size:15px;color:rgba(255,255,255,0.25);}',
    ...
    '.pnf-footer-trust li{font-size:15px;color:rgba(255,255,255,0.55);display:flex;align-items:center;gap:8px;line-height:1.5;}',
    '.pnf-footer-trust li::before{content:\'\';width:5px;height:5px;border-radius:50%;background:#6CB71E;flex-shrink:0;}',
    '.pnf-footer-popular{margin-top:32px;padding-top:24px;border-top:1px solid rgba(255,255,255,0.08);}',
    '.pnf-footer-popular h4{font-size:15px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:rgba(255,255,255,0.4);margin-bottom:12px;}',
    '.pnf-footer-popular-list{font-size:15px;line-height:2;color:rgba(255,255,255,0.4);}',
    ...
    '.pnf-overlay{position:fixed;inset:0;background:rgba(20,80,121,0.7);backdrop-filter:blur(4px);z-index:1000;display:flex;align-items:center;justify-content:center;padding:20px;opacity:0;pointer-events:none;transition:opacity 0.2s;}',
    ...
    '.pnf-modal-head{background:#145079;padding:22px 28px 18px;display:flex;align-items:flex-start;justify-content:space-between;gap:12px;}',
    '.pnf-modal-head h2{font-family:var(--pnf-display);font-size:1.2rem;font-weight:700;color:#fff;margin-bottom:3px;}',
    '.pnf-modal-head p{font-size:15px;color:rgba(255,255,255,0.5);}',
    ...
    '.pnf-cf label{font-size:15px;font-weight:700;letter-spacing:0.07em;text-transform:uppercase;color:#5A6E78;margin-bottom:5px;display:block;}',
    '.pnf-cf input,.pnf-cf select,.pnf-cf textarea{width:100%;padding:11px 14px;border:1.5px solid #D8E4E8;border-radius:7px;font-family:var(--pnf-font);font-size:15px;color:#1A2832;background:#F2FAFE;outline:none;transition:border-color 0.2s;}',
    '.pnf-cf input:focus,.pnf-cf select:focus,.pnf-cf textarea:focus{border-color:#0F86B9;background:#fff;}',
    '.pnf-cf textarea{resize:vertical;min-height:80px;line-height:1.55;}',
    '.pnf-cf-submit{width:100%;background:#0F86B9;color:#fff;border:none;padding:13px;border-radius:8px;font-family:var(--pnf-font);font-size:15px;font-weight:700;cursor:pointer;transition:background 0.2s;margin-top:2px;}',
    '.pnf-cf-submit:hover{background:#0A4A66;}',
    '.pnf-cf-submit:disabled{opacity:0.6;cursor:not-allowed;}',
    '.pnf-cf-fine{font-size:15px;color:#5A6E78;text-align:center;margin-top:6px;}',
    ...
    '.pnf-cf-success h3{font-size:18px;font-weight:700;color:#4F9E00;margin-bottom:6px;}',
    '.pnf-cf-success p{font-size:15px;color:#5A6E78;line-height:1.6;}',
    ...
    '.pnf-more-section .section-title{font-family:\'Playfair Display\',serif;font-size:1.15rem;font-weight:700;color:var(--navy,#145079);margin-bottom:16px;padding-bottom:10px;border-bottom:2px solid var(--border,#DDE5EE);}',
    ...
    '.ghost-card.gc-empty{display:block;border-style:dashed;border-color:rgba(0,176,248,.3);background:rgba(0,176,248,.03);text-align:center;padding:20px 16px;}',
    '.gc-name{font-family:\'Playfair Display\',serif;font-size:.95rem;font-weight:700;color:var(--navy,#145079);margin-bottom:3px;line-height:1.2;}',
    '.gc-sub{font-size:0.94rem;color:var(--muted,#607080);margin-bottom:8px;display:flex;align-items:center;gap:4px;}',
    '.gc-desc{font-size:0.94rem;color:var(--muted,#607080);line-height:1.55;margin-bottom:10px;}',
    '.gc-cta{font-size:0.94rem;font-weight:700;color:var(--blue,#00B0F8);}',
    ...
    '.pnf-bz-live{border-color:rgba(0,176,248,.35);background:linear-gradient(135deg,#fff,#F8FCFF);}',
    '.pnf-bz-meta{display:flex;flex-direction:column;gap:5px;font-size:0.94rem;color:var(--text,#1A2832);line-height:1.4;margin-bottom:10px;}',
    '.pnf-bz-meta a{color:var(--ocean,#0F86B9);text-decoration:none;display:inline-flex;align-items:center;gap:5px;}',
    '.pnf-bz-meta a:hover{text-decoration:underline;}',
    '.pnf-bz-meta .pnf-i{width:0.85em;height:0.85em;flex-shrink:0;}',
    '.pnf-bz-more{margin-top:auto;background:rgba(0,176,248,.08);border:1px solid rgba(0,176,248,.25);color:var(--blue,#00B0F8);font-family:\'Figtree\',sans-serif;font-size:0.94rem;font-weight:700;padding:6px 12px;border-radius:5px;cursor:pointer;align-self:flex-start;transition:background .15s;}',
    '.pnf-bz-more:hover{background:rgba(0,176,248,.16);}',
    ...
    '.pnf-bz-modal .pnf-bz-modal-eyebrow{font-size:15px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.55);margin-bottom:7px;}',
    '.pnf-bz-modal .pnf-bz-modal-sub{font-size:15px;color:rgba(255,255,255,.55);margin-top:4px;}',
    '.pnf-bz-modal-body{padding:24px 28px 26px;}',
    '.pnf-bz-blurb{font-size:15px;color:var(--text,#1A2832);line-height:1.7;margin-bottom:18px;}',
    '.pnf-bz-contact{border-top:1px solid var(--border,#DDE5EE);padding-top:16px;display:flex;flex-direction:column;gap:10px;}',
    '.pnf-bz-ci{display:flex;gap:11px;align-items:flex-start;font-size:15px;color:var(--text,#1A2832);line-height:1.5;}',
    '.pnf-bz-ci .pnf-i{color:var(--ocean,#0F86B9);width:1.05em;height:1.05em;flex-shrink:0;margin-top:1px;}',
    '.pnf-bz-ci a{color:var(--ocean,#0F86B9);text-decoration:none;font-weight:600;}',
    '.pnf-bz-ci a:hover{text-decoration:underline;}',
    '.pnf-bz-foot{margin-top:18px;padding-top:14px;border-top:1px solid var(--border,#DDE5EE);font-size:15px;color:var(--muted,#607080);line-height:1.55;font-style:italic;}',
    '.pnf-bz-foot a{color:var(--ocean,#0F86B9);font-weight:600;text-decoration:none;}',
    '.pnf-bz-foot a:hover{text-decoration:underline;}',
    '.pnf-more-cta{background:var(--navy,#145079);border-radius:12px;padding:24px 28px;display:flex;align-items:center;gap:20px;flex-wrap:wrap;}',
    ...
    '.pnf-more-cta-body p{font-size:0.94rem;color:rgba(255,255,255,.5);line-height:1.55;}',
    '.pnf-more-cta-btn{background:#6CB71E;color:#145079;font-size:0.94rem;font-weight:800;padding:10px 22px;border-radius:7px;text-decoration:none;white-space:nowrap;transition:background .2s;flex-shrink:0;}',
    '.pnf-more-cta-btn:hover{background:#5CA519;}'
  ].join('');
